...
const Add = () => {
    ...
    return (
        <div>
            <header style={{backgroundColor : "teal", padding:"15px"}}>
                <div className="header d-flex justify-content-between align-items-center">
                    ...
                    <div className="col-3  d-flex justify-content-end">
                        <Link to={`/view`} className="btn btn-light text-dark" style={{ color: "#fff", width: "80px" }}>View</Link>
                    </div>
                </div>
            </header>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 mx-auto mt-5 p-3 shadow">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className="btn" style={{backgroundColor : "black", color:"#fff"}}>Submit</button>
